...
import ru.ifmo.testing.exception.NoPropertiesException;
...
public class PropertyLoader {
    ...
    public static String returnConfigValue(final String property) {
        ...
        try (InputStream propFileInpStream = PropertyLoader.class.getClassLoader()
            ...
            LOGGER.debug(MessageFormat.format("Getting {0} inside file environment config.properties: {1}", property, properties.getProperty(property)));
